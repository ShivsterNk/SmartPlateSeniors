...
<style>
    ...
    .filter-bar {
        ...
        padding: 12px 0; position: sticky; top: 0px; z-index: 100;
    }
...
<main>
    ...
    <!-- sticky dietary filter bar (logged in only) -->
    <?php if ($isLoggedIn): ?>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <?php else: ?>
                <div id="categoryPills" style="display:none;"></div>
            <?php endif; ?>
